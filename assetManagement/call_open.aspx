<%@ Page Title="" Language="C#" MasterPageFile="~/Systems.Master" AutoEventWireup="true" CodeBehind="call_open.aspx.cs" Inherits="assetManagement.call_open" %>
                        ...
                        <div style="overflow-y: scroll">
                            ...
                            <asp:GridView ID="grid_display" runat="server" OnRowDataBound="GridView1_RowDataBound"
                                ...
                                <Columns>
                                    ...
                                    <%--<asp:ImageField DataImageUrlField="url"   ControlStyle-Width ="200" ControlStyle-Height="200" HeaderText="Image" />--%>
                                    ...
                                    <asp:TemplateField HeaderText="Allotted To">
                                        <ItemTemplate>
                                            ...
                                            <asp:DropDownList ID="allottedto" runat="server" AppendDataBoundItems="True" AutoPostBack="false" DataTextField="name" DataValueField="user_id" Height="16px">
                                                 <asp:ListItem Value="0">-- Select Name--</asp:ListItem>
                                            </asp:DropDownList>
                                             <asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" ErrorMessage="Enter Name" ControlToValidate="allottedto" ForeColor="Red"></asp:RequiredFieldValidator>
                                        </ItemTemplate>
                                    </asp:TemplateField>
