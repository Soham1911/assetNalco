<%@ Page Title="" Language="C#" MasterPageFile="~/Amc.Master" AutoEventWireup="true" CodeBehind="amc_network.aspx.cs" Inherits="assetManagement.amc_network" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <div>
        <font size="6em" color="indigo"><strong>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;NETWORK ITEM</strong></font></div>
    <table>
        <tr>
            <td />
            <td />
    ...
    <table>
        <tr>
            <td class="auto-style38">
                <asp:Label ID="Label1" runat="server" Text="Dust Cleaning" align="right" />
        ...
        <tr>
            <td class="auto-style38">
                <asp:Label ID="Label2" runat="server" Text="Socket Tightening" align="right" />
