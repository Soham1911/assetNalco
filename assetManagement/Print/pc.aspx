<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="pc.aspx.cs" Inherits="assetManagement.Print.pc" %>
...
<head runat="server">
    ...
    <script language="javascript" type="text/javascript">
        function print_rep() {
            window.print();
            window.location.href = 'amc_pm.aspx';
        }
    </script>
</head>
<body onload="print_rep">
    <form id="form1" runat="server">
        ...
        <br />
        <br />
        <font size="4em"><strong>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; PREVENTIVE MAINTENANCE OF EQUIPMENT:&nbsp;&nbsp;&nbsp;&nbsp; PC/LAPTOP</strong></font>
            ...
            <table border="1">
                ...
                <tr>
                    <td class="auto-style24">
                        <asp:Label ID="lbl_cat" runat="server" Text="Category" align="right" />
                        <td class="auto-style1" />
                ...
                <tr>
                    <td class="auto-style24">
                        ...
                        <td>
                            <asp:Label ID="lbl_office" runat="server" Text="MS Office Version" align="right" />
                        </td>
                        <td class="auto-style26">
                 ...
                 <tr>
                    <td class="auto-style24">
                        <asp:Label ID="Label1" runat="server" Text="Mail S/W" align="right" /></td>

                        <td class="auto-style1" />
                        <asp:Label ID="txt_mail" runat="server" align="left" />
                        <td>
