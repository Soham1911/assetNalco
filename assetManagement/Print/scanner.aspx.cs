...
namespace assetManagement.Print
{
    public partial class scanner : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            cmd.CommandText = "select p.pr_clean,a.amcParty,d.deptName,a.category,a.custodian,e.name,a.make,a.model,a.ast_s_no,p.conn_check,p.line,p.EtoN,p.post_check,p.engRemark from ast_master a inner join ast_pm p on a.astCode=p.astCode inner join ast_deptMaster d on d.deptCode=a.dept inner join ast_empMaster e on e.p_no=a.custodian where astCode='" + astCode + "' and scheduledDate='" + scheduledDate + "'";
            conn_asset.Open();
