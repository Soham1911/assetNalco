<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="network.aspx.cs" Inherits="assetManagement.Print.network" %>
...
<body>
    <form id="form1" runat="server">
        ...
        <br />
        <br />
        <font size="4em"><strong>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; PREVENTIVE MAINTENANCE OF EQUIPMENT:&nbsp;&nbsp;&nbsp;&nbsp; SCANNER
    ...
    <table align="center"   border="1">
        ...
        <tr>
            ...
            <td align="center">
                <asp:Label ID="txt_socket" runat="server" align="center" Enabled="false" Width="60px" />
            </td>
            ...
            <td align="center">
                <asp:Label ID="txt_conn" runat="server" align="center" Enabled="False" Width="60px" /></td>
