...
namespace assetManagement
{
    public partial class pm_fin : System.Web.UI.Page
    {
        ...
        private void BindData()
        {
            ...
            OdbcCommand cmd = conn_asset.CreateCommand();
            cmd.CommandText = "select p.astCode,p.scheduledDate,a.custodian,a.description,a.location,a.subLoc1 from ast_pm p inner join ast_master a on a.astCode=p.astCode where month='" + mon + "' and scheduledDate>='" + dsDate.ToString("yyyy/MM/dd") + "' and scheduledDate<='" + deDate.ToString("yyyy/MM/dd") + "' and lockStat='F'";
            conn_asset.Open();
