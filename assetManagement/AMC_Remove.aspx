<%@ Page Title="" Language="C#" MasterPageFile="~/Systems.Master" AutoEventWireup="true" CodeBehind="AMC_Remove.aspx.cs" Inherits="assetManagement.AMC_Remove" %>
     ...
     <div align="center">
        <div style="width: 60%;">
            ...
            <asp:UpdatePanel ID="UpdatePanel1" runat="server">
                <ContentTemplate>
                    <fieldset>
                        <legend>Remove Asset(s) From AMC</legend>
                        ...
                        <table>
                            ...
                            <tr>
                                ...
                                <td>
                                    <asp:RequiredFieldValidator ID="RequiredFieldValidator3" runat="server" ControlToValidate="txt_amcEnd" ErrorMessage="*Select Ending Date" ForeColor="Red"></asp:RequiredFieldValidator>
                                </td>
                            </tr>
                             <tr>
                                <td align="right">
                                ...
                                <td align="left" class="auto-style1">
                                    <asp:TextBox Width="230px" ID="TextBox1" runat="server"></asp:TextBox>
                            ...
                            <tr>
                                ...
                                <td align="center" class="auto-style1">
                                    <asp:Button ID="btn_reg" runat="server" Text="Remove" Font-Bold="True" ForeColor="Black" BackColor="LightSteelBlue" OnClick="btn_reg_Click" />
                                </td>
                            </tr>
                        </table>
