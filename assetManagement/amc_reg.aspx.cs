...
{
    public partial class amc_reg : System.Web.UI.Page
    {
        ...
        protected void btn_reg_Click(object sender, EventArgs e)
        {
            ...
            cmdf.CommandText = "insert into amclogin values('" + txt_uid.Text.Trim() + "','" + txt_name.Text.Trim().ToUpper() + "','" + txt_pwd.Text + "','" + txt_designation.Text.Trim().ToUpper() + "','" + txt_company.Text.Trim().ToUpper() + "')";
            conn_asset.Open();
