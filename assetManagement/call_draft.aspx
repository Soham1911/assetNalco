<%@ Page Title="" Language="C#" MasterPageFile="~/Systems.Master" AutoEventWireup="true" CodeBehind="call_draft.aspx.cs" Inherits="assetManagement.call_draft" %>
                            ...
                            <asp:GridView ID="grid_display" runat="server" OnRowDataBound="GridView1_RowDataBound"
                                ...
                                <Columns>
                                    ...
                                    <ItemTemplate>
                                        ...
                                        <%--<asp:RequiredFieldValidator ID="RequiredFieldValidator" runat="server" ErrorMessage="Enter Date" ControlToValidate="txt_date" ForeColor="Red"></asp:RequiredFieldValidator>--%>
                                    </ItemTemplate>
                                    ...
                                    <asp:TemplateField HeaderText="Attended By">
                                        <ItemTemplate>
                                            ...
                                            <%--<asp:RequiredFieldValidator ID="RequiredFieldValidator2" runat="server" ErrorMessage="Enter Name" ControlToValidate="attendedby" ForeColor="Red"></asp:RequiredFieldValidator>--%>
                                        </ItemTemplate>
                                    </asp:TemplateField>
