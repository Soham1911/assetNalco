    ...
    public partial class Issue_Report : System.Web.UI.Page
    {
        ...
        protected void btn_reg_Click(object sender, EventArgs e)
        {
            ...
            if(selected == 1)
            {
                ...
                cmda.CommandText = "select * from spare_consumables where astCode ='" + astCode + "' order by type desc";
                ...
                dt.Columns.Add(new System.Data.DataColumn("entryDate", typeof(String)));
                dt.Columns.Add(new System.Data.DataColumn("amcID", typeof(String)));
                ...
                while (dr.Read())
                {
                    ...
                    newRow["entryDate"] = Convert.ToString(dr["doi"]);
                    newRow["amcID"] = Convert.ToString(dr["amcID"]);
            ...
            if (selected == 2)
            {
                ...
                conn_asset.Open();
                OdbcCommand cmda = conn_asset.CreateCommand();
                cmda.CommandText = "select * from spare_consumables where doi >= '" + fdate + "' and doi <= '" + tdate + "'";
                OdbcDataAdapter da = new OdbcDataAdapter();
                DataTable dt = new DataTable();
                DataRow newRow;
                OdbcDataReader dr = cmda.ExecuteReader();
            ...
            if (selected == 3)
            {
                ...
                conn_asset.Open();
                OdbcCommand cmda = conn_asset.CreateCommand();
                cmda.CommandText = "select * from spare_consumables where type = '" + value.Trim() + "'";
                OdbcDataAdapter da = new OdbcDataAdapter();
                DataTable dt = new DataTable();
                DataRow newRow;
                OdbcDataReader dr = cmda.ExecuteReader();
        ...
        private void ExportGridToExcel()
        {
            ...
            string FileName = "Spare_Issue_Report_" + date + ".xls";
