<%@ Page Title="" Language="C#" MasterPageFile="~/Systems.Master" AutoEventWireup="true" CodeBehind="Asset_AllotUser.aspx.cs" Inherits="assetManagement.Asset_Allot" %>
                ...
                <ContentTemplate>
                    <fieldset>
                        ...
                        <table>
                            ...
                            <tr>
                                <td colspan="2" style="text-align: left">
                                    <asp:Label ID="lbl_gender" runat="server" Font-Size="Medium" Text="Gender : " Visible="false" Style="font-size: small; font-weight: 700;" ForeColor="Black"></asp:Label>
                                </td>
                            </tr>
                            <tr>
                                <td colspan="2"  style="text-align: left">
