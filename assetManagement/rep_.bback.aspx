<%@ Page Title="" Language="C#" MasterPageFile="~/Systems.Master" AutoEventWireup="true" CodeBehind="rep_.bback.aspx.cs" Inherits="assetManagement.rep__bback" %>
            ...
            <tr>
                ...
                <td>
                    <asp:DropDownList ID="drp_by" align="left" AutoPostBack="true" OnSelectedIndexChanged="drp_by_SelectedIndexChanged" runat="server">
                        ...
                        <asp:ListItem Value="all" Text="All Complaints" />
                    </asp:DropDownList>
                </td>
            </tr>
            <tr>
                        ...
                        <div style="overflow-y: scroll">
                            ...
                            <asp:GridView ID="grid_astcode" Visible="false" runat="server"
                                ...
                                <Columns>
                                    ...
                                    <asp:BoundField DataField="openingDate" HeaderText="Opening Date" DataFormatString="{0:yyyy/MM/dd}"
                                        ItemStyle-HorizontalAlign="Left" SortExpression="Opening Date" HeaderStyle-HorizontalAlign="Left">
                                        <HeaderStyle HorizontalAlign="Left"></HeaderStyle>
                                    </asp:BoundField>

                                    <asp:BoundField DataField="closingDate" HeaderText="Closing Date" DataFormatString="{0:yyyy/MM/dd}"
                                        ItemStyle-HorizontalAlign="Left" SortExpression="Closing Date" HeaderStyle-HorizontalAlign="Left">
                                        <HeaderStyle HorizontalAlign="Left"></HeaderStyle>
                                    </asp:BoundField>

                                    <asp:BoundField DataField="userDescription" HeaderText="User Description"
                                        ItemStyle-HorizontalAlign="Left" SortExpression="User Description" HeaderStyle-HorizontalAlign="Left">
                                        <HeaderStyle HorizontalAlign="Left"></HeaderStyle>
                                    </asp:BoundField>

                                    <asp:BoundField DataField="systemDescription" HeaderText="System Description"
                                        ItemStyle-HorizontalAlign="Left" SortExpression="System Description" HeaderStyle-HorizontalAlign="Left">
                                        <HeaderStyle HorizontalAlign="Left"></HeaderStyle>
                                    </asp:BoundField>

                                    <asp:BoundField DataField="partRepaired" HeaderText="Part Repaired"
                                        ItemStyle-HorizontalAlign="Left" SortExpression="Part Repaired" HeaderStyle-HorizontalAlign="Left">
                                        <HeaderStyle HorizontalAlign="Left"></HeaderStyle>
                                    </asp:BoundField>
