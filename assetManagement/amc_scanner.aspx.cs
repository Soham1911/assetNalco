...
namespace assetManagement
{
    public partial class amc_scanner : System.Web.UI.Page
    {
        ...
        
        {
            ...
            OdbcCommand cmd = conn_asset.CreateCommand();
            cmd.CommandText = "update ast_pm set compStat='D', line='" + line + "',EtoN='" + en + "',post_check='" + postpm + "', engRemark='" + remark + "',actualDate='" + actDate + "',conn_check='" + conn + "', sc_clean='" + clean + "' where astCode='" + astCode + "' and scheduledDate='" + txt_scheduledDate.Text + "' ";
            conn_asset.Open();
            cmd.ExecuteNonQuery();
            conn_asset.Close();
