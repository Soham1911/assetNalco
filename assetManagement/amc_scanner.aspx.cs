...
{
    public partial class amc_scanner : System.Web.UI.Page
    {
        ...
        protected void btn_sub_Click(object sender, EventArgs e)
        {
            ...
            OdbcCommand cmd = conn_asset.CreateCommand();
            cmd.CommandText = "update ast_pm set compStat='D', set line='" + line + "',set EtoN='" + en + "',post_check='" + postpm + "',set engRemark='" + remark + "',set actualDate='" + actDate + "',set conn_check='" + conn + "',set sc_clean='" + clean + "' where astCode='" + astCode + "' and scheduledDate='" + scheduledDate + "' ";
            conn_asset.Open();
            cmd.ExecuteNonQuery();
            conn_asset.Close();
        }
