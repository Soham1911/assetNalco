...
namespace assetManagement
{
    ...
    public partial class AMC_Entry : System.Web.UI.Page
    {
        ...
        protected void btn_reg_Click(object sender, EventArgs e)
        {
            ...
            cmd.CommandText = "update ast_master set amcParty = '"+txt_amcParty.Text.Trim().ToUpper()+"' , amcStart = '"+txt_amcStart.Text+"' , amcStat = 'Y' where po_no = '"+txt_po_no.Text.Trim()+"' or astCode = '"+txt_assetCode.Text.Trim().ToUpper()+"'";
            int check1;
            conn_asset.Open();
