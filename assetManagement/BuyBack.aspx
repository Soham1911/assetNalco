<%@ Page Title="" Language="C#" MasterPageFile="~/Systems.Master" AutoEventWireup="true" CodeBehind="BuyBack.aspx.cs" Inherits="assetManagement.BuyBack" %>
<%@ Register
                ...
                <ContentTemplate>
                    <fieldset>
                        ...
                        <table>
                            ...
                            <tr>
                                <td align="right">
                                    <font size="2em">      Buy Back Date :</font>
                                </td>
                                <td align="left">
                                    <asp:TextBox Width="230px" ID="txt_buyback" runat="server"></asp:TextBox>
                                    <asp:CalendarExtender ID="CalendarExtender7" runat="server"
                                        Enabled="True" Format="yyyy/MM/dd" TargetControlID="txt_buyback"></asp:CalendarExtender>
                                </td>
                                <td>
                                    <asp:RequiredFieldValidator ID="RequiredFieldValidator3" runat="server" ControlToValidate="txt_buyback" ErrorMessage="*Select Starting Date" ForeColor="Red"></asp:RequiredFieldValidator>
                                </td>
                            </tr>
