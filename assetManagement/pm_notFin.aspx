<%@ Page Title="" Language="C#" MasterPageFile="~/Systems.Master" AutoEventWireup="true" CodeBehind="pm_notFin.aspx.cs" Inherits="assetManagement.pm_sys" %>
                            ...
                            <Columns>
                                ...
                                <asp:TemplateField HeaderText="PM Status">
                                    <ItemTemplate>
                                        ...
                                        <asp:DropDownList ID="stat" runat="server" Width="50px">
