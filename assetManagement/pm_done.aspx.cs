...
{
    public partial class pm_done : System.Web.UI.Page
    {
        ...
        private void BindData()
        {
            ...
            cmd.CommandText = "select p.astCode,p.scheduledDate,a.custodian,a.description,a.location,a.subLoc from ast_pm p inner join ast_pc a on a.astCode=p.astCode where month='" + mon + "' and scheduledDate>='" + dsDate + "' and scheduledDate<='" + deDate + "' and lockStat='D'";
            conn_asset.Open();
